        ...
        <div className={`max-w-screen-2xl container mx-auto md:px-20 fixed top-0 left-0 right-0 ${
            ...
            <div className="navbar">
                <div className="navbar-start">
                    ...
                    <a className="text-2xl font-bold cursor-pointer ">Our Store</a>
                </div>
                <div className="navbar-end">
                    ...
                    <div className='hidden md:block'>
                        <label className="border rounded-md px-3 py-1 flex items-center gap-2">
                            <input type="text h-4" className="grow outline-none" placeholder="Search" />
                    ...
                    <div >
                        <a className="bg-black text-white px-2 py-2 mx-1 cursor-pointer rounded-md hover:bg-slate-800 duration-300">Login</a>
                    </div>
                </div>
            </div>
        </div>
